	...
	<!--header-->
		<div class="header">
			<div class="header-top">
				<div class="container">
					 <div class="top-left">
						<a href="mail.php"> Help  <i class="glyphicon glyphicon-phone" aria-hidden="true"></i>+91 9586677078  </a>
					</div>
					<div class="top-right">
					<ul>
						<?php
				...
				<div class="container">
					<div class="logo-nav">
						<div class="logo-nav-left">
							<h1><a href="index.php">Ready2Wear <span>Shopping Made Simple</span></a></h1>
						</div>
