...
<html>
<body background="image/background2.jpg" style="background-repeat: no-repeat;background-size: 1750px 800px;">
	<div class="main" style="background:rgba(0,0,0,0.5);color:white;margin-right: 560px;margin-left: 400px " >
		...
		<h1 style="background-color: black;margin-left: -15px;text-align: center">Admin Login</h1>
